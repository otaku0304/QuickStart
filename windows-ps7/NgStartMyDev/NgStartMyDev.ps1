...
# === CONFIG ===
$frontendPath = "{{FRONTEND_PATH}}" # change to your frontend path
$frontendPort = "{{FRONTEND_PORT}}" # change to your frontend port
$gitBranch = "{{GIT_BRANCH}}" # change to your git branch, e.g., "development"
